          ...
          <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="center" style="padding: 20px 0;">
                <table role="presentation" width="600" border="0" cellspacing="0" cellpadding="0" style="background-color: white; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.05);">
                  <!-- Cabeçalho com logo e cor de fundo -->
                  <tr>
                    <td align="center" style="padding: 30px 20px; background-color: #4CAF50; border-radius: 8px 8px 0 0;">
                      <!-- Logo em base64 -->
                  ...
                  <tr>
                    <td style="padding: 40px 30px;">
                      <p style="font-size: 16px; margin-top: 0; color: #333;">Olá,</p>
                      ...
                      <p style="font-size: 16px; line-height: 1.5; color: #333; margin-bottom: 25px;">
                        Você pode acessar sua conta a qualquer momento usando seu e-mail e senha.
                      </p>
                      ...
                      <table role="presentation" border="0" cellspacing="0" cellpadding="0" style="margin: 30px 0;">
                        <tr>
                          <td align="center">
                            <a href="https://landing-leap-solanobicalho.replit.app" style="display: inline-block; padding: 14px 30px; background-color: #4CAF50; color: white; text-decoration: none; font-weight: bold; border-radius: 5px; font-size: 16px;">ACESSAR MINHA CONTA</a>
                          </td>
                        </tr>
                      </table>
                  ...
                  <!-- Rodapé -->
                  <tr>
                    <td style="padding: 20px; text-align: center; background-color: #f7f7f7; border-radius: 0 0 8px 8px;">
                      <p style="font-size: 14px; color: #777; margin: 0;">Atenciosamente,<br>Equipe PlannerPro</p>
                      <p style="font-size: 12px; color: #999; margin-top: 15px;">© 2025 PlannerPro Organizer. Todos os direitos reservados.</p>
                    </td>
                  </tr>
                </table>
              </td>
